    ...
    STRUCT_SETUP(DB_ENV, dbrename,    "int  (*%s) (DB_ENV *, DB_TXN *, const char *, const char *, const char *, uint32_t)");
        ...
        const char *extra[]={
                 ...
                 "void (*change_fsync_log_period)(DB_ENV*, uint32_t)",
                             "int (*iterate_pending_lock_requests)(DB_ENV *env, int (*callback)(DB *db, uint64_t requesting_txnid, DBT *left_key, DBT *right_key, uint64_t blocking_txnid, uint64_t start_time, void *extra), void *extra);",
                             "int (*iterate_live_transactions)(DB_ENV *env, int (*callback)(DB_TXN *txn, void *extra), void *extra);",
                             NULL};
